...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SQL_CALC_FOUND_ROWS = 669,     /* SQL_CALC_FOUND_ROWS  */
    SQL_NO_CACHE = 670,            /* SQL_NO_CACHE  */
    SQL_SMALL_RESULT = 671,        /* SQL_SMALL_RESULT  */
    STABLE = 672,                  /* STABLE  */
    ...
    STORAGE = 679,                 /* STORAGE  */
    STORED = 680,                  /* STORED  */
    STRAIGHT_JOIN = 681,           /* STRAIGHT_JOIN  */
    ...
    TIMESTAMPADD = 703,            /* TIMESTAMPADD  */
    TIMESTAMPDIFF = 704,           /* TIMESTAMPDIFF  */
    TO = 705,                      /* TO  */
    ...
    WITH_LA = 779,                 /* WITH_LA  */
    SINGLE_COLON = 780,            /* SINGLE_COLON  */
    CONDITIONLESS_JOIN = 781,      /* CONDITIONLESS_JOIN  */
    POSTFIXOP = 782,               /* POSTFIXOP  */
    UMINUS = 783                   /* UMINUS  */
  };
...
#line 643 "third_party/libpg_query/grammar/grammar_out.hpp"
