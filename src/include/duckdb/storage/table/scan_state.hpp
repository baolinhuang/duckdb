...
public:
	//! db is required because the scan byte budget (scan_target_size_bytes) is decided here for every scan
	//! entry point, including those that run without a ClientContext
